...
export default function SearchNews({ isLogin, isSearchDone, isMore, topic, handleShowMore, cards, savedCards, handleSaveCards }) {
    ...
    return (
        <section className={searchClass}>
            ...
            <NewsCardList isLogin={isLogin} isSavedPage={false} topic={topic} cards={cards} savedCards={savedCards} isMore={isMore} handleSaveCards={handleSaveCards} />
