...
export default function Header({ isLogin, handleSigninOpen, handleLogout }) {
    return (
        <header className="header">
            <Navigation isLogin={isLogin} isLight={false} handleSigninOpen={handleSigninOpen} handleLogout={handleLogout} />
