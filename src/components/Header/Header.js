...
export default function Header({ isLogin, handleHindMore, handleSearch, handleSearchSubmit, handleSigninOpen, handleLogout, handleNavOpen }) {
    return (
        <header className="header">
            ...
            <SearchForm handleHindMore={handleHindMore} handleSearch={handleSearch} handleSearchSubmit={handleSearchSubmit} />
        </header>
    )
}