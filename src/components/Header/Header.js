...
export default function Header({ disable, isLogin, handleHindMore, handleSearch, handleSearchSubmit, handleSigninOpen, handleLogout, handleNavOpen }) {
    return (
        <header className="header">
            ...
            <SearchForm disable={disable} handleHindMore={handleHindMore} handleSearch={handleSearch} handleSearchSubmit={handleSearchSubmit} />
        </header>
    )
}