    ...
    return (
        <section className="about">
            ...
            <div className="about__text-box">
                ...
                <p className="about__text">Hello, I am Pinwei Wu. In 2020, I was selected to join Practicum by Yandex Web Developer beta-testing program - a intensive 10-month course in web development that covers HTML, CSS, JavaScript, React, back-end infrastructure, and more.
